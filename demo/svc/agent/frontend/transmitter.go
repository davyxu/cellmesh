...
// 来自客户端的消息
func (directTransmitter) OnRecvMessage(ses cellnet.Session) (msg interface{}, err error) {
...
// 网关发往客户端的消息
func (directTransmitter) OnSendMessage(ses cellnet.Session, msg interface{}) (err error) {
