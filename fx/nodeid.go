...
// 构造指定服务的ID
func MakeNodeID(svcName string) string {
	return fmt.Sprintf("%s#%d@%s", svcName, NodeIndex, NodeGroup)
}

func ParseNodeID(svcid string) (svcName string, svcIndex int, svcGroup string, err error) {
